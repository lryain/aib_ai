...
class ButtonHandler:
    ...
    def __init__(self):
        self.enter_gpio = 139  # GPIO4_B3 13
        self.up_gpio = 63  # GPIO1_D7 33
        self.down_gpio = 43  # GPIO1_B3 23
        self.back_gpio = 138  # GPIO4_B2 11
    ...
    def _post_pygame_event(self, key):
        newevent = pygame.event.Event(
            pygame.KEYDOWN, key=key, mod=pygame.locals.KMOD_NONE
        )  # create the event
